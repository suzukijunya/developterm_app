...
// 1200/2500/5000語)を12段階に割り振り、FSIなど言語難易度研究で目安とされる英語話者の
...
const LEVELS = [
  {
    ...
    hskLabel: "HSK1相当",
    unitIds: ["u1", "u2", "u21"],
    description: "あいさつ・数字・飲食の注文など、基本のフレーズが言える",
    implemented: true,
    targetVocab: 150,
    targetHours: 100,
  },
  {
    ...
    hskLabel: "HSK1〜2相当",
    unitIds: ["u3", "u4"],
    description: "家族や日常生活について、短い文でやりとりできる",
    implemented: true,
    targetVocab: 250,
    targetHours: 160,
  },
  {
    ...
    hskLabel: "HSK2相当",
    unitIds: ["u22", "u23", "u14"],
    description: "天気・趣味・中国での買い物や移動など、身近な話題を話せる",
    implemented: true,
    targetVocab: 400,
    targetHours: 250,
  },
  {
    ...
    hskLabel: "HSK2〜3相当",
    unitIds: ["u24", "u5"],
    description: "体調を伝える・仕事の自己紹介など、生活と仕事の基本に対応できる",
    implemented: true,
    targetVocab: 600,
    targetHours: 350,
  },
  {
    ...
    hskLabel: "HSK3相当",
    unitIds: ["u6", "u15", "u25"],
    description: "電話・メール・チャットで仕事の基本連絡ができる",
    implemented: true,
    targetVocab: 800,
    targetHours: 500,
  },
  {
    ...
    hskLabel: "HSK3〜4相当",
    unitIds: ["u7", "u8", "u16"],
    description: "会議・商談・出張・オンライン会議の基本場面に対応できる",
    implemented: true,
    targetVocab: 1200,
    targetHours: 700,
  },
  {
    ...
    hskLabel: "HSK4相当",
    unitIds: ["u26", "u9", "u10"],
    description: "展示会や工場見学の案内、プレゼン、クレーム対応ができる",
    implemented: true,
    targetVocab: 1600,
    targetHours: 900,
  },
  {
    ...
    hskLabel: "HSK4〜5相当",
    unitIds: ["u27", "u17", "u18"],
    description: "営業・IT開発・経理など専門分野の実務でやりとりできる",
    implemented: true,
    targetVocab: 2000,
    targetHours: 1200,
  },
  {
    ...
    hskLabel: "HSK5相当",
    unitIds: ["u28", "u11", "u29"],
    description: "品質管理・採用・部下の評価など、管理職の業務をこなせる",
    implemented: true,
    targetVocab: 2500,
    targetHours: 1500,
  },
  {
    ...
    hskLabel: "HSK5〜6相当",
    unitIds: ["u12", "u13"],
    description: "契約書やビジネス文書を読み、条件を詰められる",
    implemented: true,
    targetVocab: 3200,
    targetHours: 1800,
  },
  {
    ...
    hskLabel: "HSK6相当",
    unitIds: ["u30", "u19", "u20"],
    description: "貿易実務・通関・緊急時の対応を通訳なしで進められる",
    implemented: true,
    targetVocab: 4000,
    targetHours: 2200,
  },
  {
    ...
    hskLabel: "HSK6+相当",
    unitIds: ["u31", "u32"],
    description: "ゴール: 経済ニュースを理解し、スピーチや難しい交渉を主導できる",
    implemented: true,
    targetVocab: 5000,
    targetHours: 2500,
  },
